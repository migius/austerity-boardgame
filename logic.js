...
function addAction(text, logic)
{
  ...
  btnAction.addEventListener('click', logic, false);
...
{ 
  ...
  switch (draw) {
    case "KK":
      ...
      addAction("Reduce Wealth by one [TODO: mettere in dictionary]", function(){window.Wealth = Math.max(window.Wealth -1,window.MIN_POINTS);endAction();});
